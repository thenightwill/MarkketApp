        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UnitValue = table.Column<decimal>(type: "decimal(18,3)", precision: 18, scale: 3, nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Products_ActiveIdentity",
                table: "Products",
                columns: new[] { "Name", "Brand", "Category", "UnitType", "UnitValue" },
                unique: true,
                filter: "[IsActive] = 1");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WarehouseStocks_ProductId_BatchNumber",
                table: "WarehouseStocks",
                columns: new[] { "ProductId", "BatchNumber" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WarehouseStocks_ProductId_ExpirationDate",
                table: "WarehouseStocks",
